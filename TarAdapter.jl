...
# I wish I didn't have to define these, why can't there be default implementations?
# function Base.readbytes!(tio::TarFileIO, buff::AbstractArray{UInt8}, n=length(buff))
#     n = min(n, filesize(tio) - position(tio))
#     unsafe_read(tio, pointer(buff), n)
#     return n
# end
