...
export registry_hashes, registries_dir, registry_download_path, download_registry
...
const registries_dir = joinpath(dirname(@__DIR__), "..", "registries")
